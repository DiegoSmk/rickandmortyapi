                        ...
                        <div className="left-details-box">
                          <div className="modal-details-grid">
                            <div className="detail-item">
                              <span className="label">{t('modal.origin')}</span>
                              <span className="value">{selectedCharacter.origin || t('modal.unknown')}</span>
                            </div>
                            <div className="detail-item">
                              <span className="label">{t('modal.location')}</span>
                              <span className="value">{selectedCharacter.location || t('modal.unknown')}</span>
                            </div>
                            <div className="detail-item">
                              <span className="label">{t('modal.first_seen_in')}</span>
                          ...
                          <div className={`ii-context ai-log-section mini ${!selectedCharacter.aiProfile?.sections?.description?.narrative_summary ? 'public-context' : ''}`}>
                            {(() => {
                              const hasGeneratedDescription = Boolean(selectedCharacter.aiProfile?.sections?.description?.narrative_summary);
